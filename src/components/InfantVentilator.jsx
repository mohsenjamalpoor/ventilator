  ...
  const interpretABG = () => {
    ...
    if (pHNum < 7.35) {
      ...
      if (pCO2Num > 45) {
        ...
        const expectedHCO3 = 24 + ((pCO2Num - 40) / 10) * 1
        ...
        newSettings.respiratoryRate = Math.min(45, currentSettings.respiratoryRate + 5)
        if (selectedMode === 'PCV') {
          newSettings.pip = Math.min(25, currentSettings.pip + 2)
        }
      } else if (HCO3Num < 22) {
      ...
      if (pCO2Num < 35) {
        ...
        // محاسبه جبران متابولیک مورد انتظار
        const expectedHCO3 = 24 - ((40 - pCO2Num) / 10) * 2
        if (HCO3Num < expectedHCO3 - 2) {
          compensation = 'جبران نشده'
        } else if (HCO3Num >= expectedHCO3 - 2 && HCO3Num <= expectedHCO3 + 2) {
          compensation = 'جبران حاد'
        ...
        newSettings.respiratoryRate = Math.max(20, currentSettings.respiratoryRate - 5)
      } else if (HCO3Num > 26) {
    ...
    if (pO2Num < 50) {
      ...
      newSettings.fio2 = Math.min(80, currentSettings.fio2 + 20)
      newSettings.peep = Math.min(8, currentSettings.peep + 2)
    } else if (pO2Num < 60) {
      oxygenationStatus = 'هیپوکسمی'
      newSettings.fio2 = Math.min(60, currentSettings.fio2 + 10)
      newSettings.peep = Math.min(7, currentSettings.peep + 1)
    } else if (pO2Num < 80) {
      oxygenationStatus = 'هیپوکسمی خفیف'
    } else {
          ...
          <div className="lg:col-span-2">
            <div className="grid grid-cols-1 gap-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                {/* راهنمای محدوده نرمال */}
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                  <h3 className="font-bold text-blue-800 mb-2"> محدوده‌های نرمال برای نوزادان:</h3>
                  <div className="grid grid-cols-2 gap-2 text-sm text-blue-700">
                    <div>• pH: 7.35 - 7.45</div>
                    <div>• pCO₂: 35 - 45 mmHg</div>
                    <div>• pO₂: 60 - 80 mmHg</div>
